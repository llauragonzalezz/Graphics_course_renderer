//
// ConstructiveSolidUnion.hpp
//
// Description:
//  Figure union wrapper
//
// Authors:
//  Samuel García
//  Laura González
...
#ifndef INFORMATICA_GRAFICA_CONSTRUCTIVESOLIDUNION_HPP
#define INFORMATICA_GRAFICA_CONSTRUCTIVESOLIDUNION_HPP

#include <memory>
#include "Figure.hpp"

class ConstructiveSolidUnion: public Figure {

public:
    std::shared_ptr<Figure> fig1;
    std::shared_ptr<Figure> fig2;

    ConstructiveSolidUnion(std::shared_ptr<Figure> _fig1, std::shared_ptr<Figure> _fig2){
            fig1 = _fig1;
            fig2 = _fig2;
    }
...
#endif //INFORMATICA_GRAFICA_CONSTRUCTIVESOLIDUNION_HPP
